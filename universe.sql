...
ALTER SEQUENCE public.moon_star_id_seq OWNED BY public.moon.moon_id;
...
ALTER TABLE ONLY public.moon ALTER COLUMN moon_id SET DEFAULT nextval('public.moon_star_id_seq'::regclass);
